"""Dataset indexer + materializer for the shufflebuffer loader (data=mecka_all_sb), Modal-native.

Builds the per-sample tar shards that SBShardIterableDataset consumes. Every volume is mounted on
every function (read anything directly). Pipeline:
...
Loader: github.com/modal-projects/shufflebuffer  (see egomimic/rldb/zarr/SHUFFLEBUFFER.md)
